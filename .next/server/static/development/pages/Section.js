...
/* harmony import */ var _Components_SectionFrom__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Components/SectionFrom */ "./Components/SectionFrom.js");
...
const table_header = ["id", "name", "description"];
...
class Section extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  make_table(data) {
    var table = [];
  ...
  render() {
    ...
    return __jsx(react_redux__WEBPACK_IMPORTED_MODULE_4__["Provider"], {
      ...
      __self: this
    }, __jsx(_Components_SectionFrom__WEBPACK_IMPORTED_MODULE_7__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 38
      },
...
Section.getInitialProps = async function () {
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()('http://127.0.0.1:8000/lab/Section/', {
    method: 'GET',
    headers: {
...
/***/ 3:
/*!********************************!*\
  !*** multi ./pages/Section.js ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! J:\Project\ReactLims\pages\Section.js */"./pages/Section.js");
