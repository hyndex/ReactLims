    ...
    constructor(){
        ...
        this.state = {
         ...
         try {
            ...
            store.dispatch({type:'ChangeToken',payload:{Token:Token}})
            fetch('http://127.0.0.1:8000/users/Permission/',
            {
                ...
                if(permission == '"{\"user not permitted\"}"'){
                    const cookies = new Cookies();
                    cookies.remove('Token');
                    store.dispatch({type:'ChangeToken',payload:{Token:''}})
                }
                else{
                    //redireact
                }
             ...
             console.log('No Previous Token Exist')
         }
